package
{
   ...
   public class Enemy extends Sprite
   {
      ...
      private function OnOver(param1:MouseEvent) : void
      {
         ...
         _loc6_ += 45;
         var _loc9_:TextField = Tooltip.AddTextField(10,_loc6_ - 4,400 - 20,Constants.TEXT_FORMAT_TT_DESC_ID);
         ...
         var _loc12_:TextField = Tooltip.AddTextField(10,_loc6_,400 - 20,Constants.TEXT_FORMAT_TT_DESC);
         _loc12_.htmlText = "";
         if(DPSCalculator.TESTING)
         {
            _loc33_ = Constants.TEXT_FORMAT_TT_DESC.Clone();
            _loc33_.color = 16777215;
            _loc34_ = Tooltip.AddTextField(400,_loc6_,0,_loc33_);
            _loc34_.htmlText = "";
         ...
         if(_loc32_)
         {
            ...
            _loc41_ = Tooltip.AddTextField(_loc35_[4],_loc36_,400 - _loc35_[4],Constants.TEXT_FORMAT_TT_DESC_ATT);
            ...
            while(_loc30_ < _loc32_)
            {
               ...
               if(DPSCalculator.TESTING)
               {
                  _loc57_ = Tooltip.AddTextField(400,_loc36_ + (_loc30_ + 1) * 18,200,_loc47_);
               ...
               _loc53_ = Tooltip.AddTextField(_loc35_[4],_loc36_ + (_loc30_ + 1) * 18,400 - _loc35_[4],Constants.TEXT_FORMAT_TT_DESC_ATT);
