package
{
   ...
   public class Item extends Sprite
   {
      ...
      private function OnOver(param1:MouseEvent) : void
      {
         ...
         _loc6_ += 45;
         _loc11_ = Tooltip.AddTextField(10,_loc6_,246 - 20,Constants.TEXT_FORMAT_TT_DESC);
         ...
         _loc13_ = Tooltip.AddTextField(10,_loc6_,246 - 20,Constants.TEXT_FORMAT_TT_DESC);
         _loc13_.htmlText = "";
         ...
         if(this.m_Xml.@setType != undefined)
         {
            ...
            _loc102_ = Tooltip.AddTextField(10,_loc6_,246 - 20,Constants.TEXT_FORMAT_TT_DESC);
         ...
         _loc39_ = Tooltip.AddTextField(10,_loc6_,246 - 20,Constants.TEXT_FORMAT_TT_DESC);
