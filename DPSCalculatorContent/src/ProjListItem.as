package
{
   ...
   public class ProjListItem extends Sprite
   {
      ...
      public function ProjListItem(param1:XML)
      {
         super();
      ...
      public function Update(param1:*) : void
      {
         if(param1 != null)
         {
            ...
            this.s.y = 2;
            this.s.x = 2;
            this.s.filters = [Constants.GLOW_BLACK_TT_CONTENT];
            addChild(this.s);
         }
      }
      ...
      private function OnOver(param1:MouseEvent) : void
      {
         ...
         var _loc6_:TextField = Tooltip.AddTextField(4,0,260 - 20,Constants.TEXT_FORMAT_TT_HEADER);
         ...
         _loc7_ = Tooltip.AddTextField(4,Math.ceil(_loc6_.textHeight) + 40,260 - 20,Constants.TEXT_FORMAT_TT_DESC);
         _loc7_.text = "";
