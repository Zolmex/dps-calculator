package
{
   ...
   public class BulletPreview extends Sprite
   {
      ...
      {
         this.cbAutoFire.selected = this.m_bAutoFire = this.m_bAutoFire ? false : true;
      }
      ...
      {
         this.cbOffcent.selected = this.m_bOriginBot = this.m_bOriginBot ? false : true;
         this.UpdateRangeAbil();
         this.UpdateRangeWep();
         this.DrawBulletTrajectory();
      }
      ...
      {
         this.cbShowPath.selected = this.m_BulletTraj.visible = this.m_BulletTraj.visible ? false : true;
      }
