...
public class TLFTextContainerManager extends TextContainerManager
   {
      ...
      override public function factoryUpdateContainerChildren() : void
      {
      ...
      override public function clearContainerChildren(param1:Boolean) : void
      {
      ...
      override public function addInlineGraphicElement(param1:DisplayObjectContainer, param2:DisplayObject, param3:int) : void
      {
