...
public class TLFTextField extends Sprite
   {
      ...
      public static const INVALID_NONE:uint = 0;
      
      public static const INVALID_TEXT:uint = 1;
      
      public static const INVALID_DIMENSIONS:uint = 2;
      
      public static const INVALID_BORDER:uint = 4;
      
      public static const INVALID_WORD_WRAP:uint = 8;
      
      public static const INVALID_SELECTION:uint = 16;
      
      public static const INVALID_AUTO_SIZE:uint = 32;
      
      public static const INVALID_TYPE:uint = 64;
      
      public static const INVALID_ALL:uint = INVALID_TEXT | INVALID_DIMENSIONS | INVALID_BORDER | INVALID_WORD_WRAP | INVALID_SELECTION | INVALID_AUTO_SIZE | INVALID_TYPE;
      
      public static var alwaysShowSelectionOnFormat:SelectionFormat = new SelectionFormat(14937852,1,"normal",0,0,"normal",0);
      
      public static var alwaysShowSelectionOffFormat:SelectionFormat = new SelectionFormat(12047870,0,"normal",0,0,"normal",0);
      
      public static var focusedSelectionFormat:SelectionFormat = new SelectionFormat(12047870,1,"normal",0,1,"normal",500);
      
      public static var inactiveSelectionFormat:SelectionFormat = new SelectionFormat(12047870,0,"normal",0,0,"normal",0);
      
      protected static var useTCM:Boolean = true;
      
      public static var genericFonts:Array = ["_sans","_serif","_typewriter","_gothic","_gothicMono","_mincho","_ゴシック","_等幅","_明朝"];
      
      public static var _initialDefaultTextFormat:TextFormat = new TextFormat("Times New Roman",12,0,false,false,false,"","",TextFormatAlign.LEFT,0,0,0,null);
      ...
      public static function repeat(param1:String, param2:String) : String
      {
         var _loc3_:String = "";
         var _loc4_:int = 0;
      ...
      public static function createTextLayoutFormat(param1:TextFormat) : TextLayoutFormat
      {
      ...
      public function repaint(param1:Event = null) : void
      {
      ...
      public function doImport(param1:String, param2:String) : void
      {
      ...
      public function getEditingMode(param1:ISelectionManager) : String
      {
         return !!param1 ? param1.editingMode : EditingMode.READ_ONLY;
      }
      
      public function get firstField() : TLFTextField
      {
      ...
      public function addNextField(param1:TLFTextField) : void
      {
      ...
      public function textFlow_ScrollHandler(param1:TextLayoutEvent) : void
      {
      ...
      public function set generationID(param1:int) : void
      {
         this._generationID = param1;
      }
      
      public function get usesTCM() : Boolean
      {
         return this._containerManager is SingleTextContainerManager;
      }
      
      public function textFlow_flowOperationEndHandler(param1:FlowOperationEvent) : void
      {
      ...
      public function get prevField() : TLFTextField
      {
         var _loc1_:int = 0;
         var _loc2_:TLFContainerController = null;
      ...
      public function get textWidth() : Number
      {
         ...
         var _loc1_:Number = isNaN(Number(this.paddingLeft)) ? 0 : Number(this.paddingLeft);
         var _loc2_:Number = isNaN(Number(this.paddingRight)) ? 0 : Number(this.paddingRight);
      ...
      public function get textHeight() : Number
      {
         this.repaint();
         this._containerManager.compose();
         var _loc1_:Number = isNaN(Number(this.paddingTop)) ? 0 : Number(this.paddingTop);
         var _loc2_:Number = isNaN(Number(this.paddingBottom)) ? 0 : Number(this.paddingBottom);
      ...
      public function get passwordCharacter() : String
      {
      ...
      public function get inlineInfo() : *
      {
      ...
      public function composeComplete(param1:CompositionCompleteEvent) : void
      {
      ...
      public function switchToEditingMode(param1:TextFlow, param2:String, param3:Boolean = true) : void
      {
      ...
      public function get maxScrollV() : int
      {
         ...
         var _loc4_:int = !this._containerManager.columnCount || this._containerManager.columnCount == FormatValue.AUTO ? 1 : int(this._containerManager.columnCount);
      ...
      public function updateComplete(param1:UpdateCompleteEvent) : void
      {
      ...
      public function invalidate(param1:uint) : void
      {
      ...
      public function insertWithParagraphs(param1:EditManager, param2:String) : void
      {
         var _loc3_:Array = null;
         var _loc4_:Number = NaN;
      ...
      public function removeTextFlowEventListeners() : void
      {
      ...
      public function textFlow_flowOperationBeginHandler(param1:FlowOperationEvent) : void
      {
      ...
      public function get pixelMinScrollV() : int
      {
         return 0;
      }
      ...
      public function addTextFlowEventListeners() : void
      {
         this._containerManager.addListeners();
      }
      ...
      public function set isPointText(param1:Boolean) : void
      {
      ...
      public function get TCMUsesTextStringAndFormat() : Boolean
      {
      ...
      public function get nextField() : TLFTextField
      {
         var _loc1_:int = 0;
         var _loc2_:TLFContainerController = null;
         if(Boolean(this.textFlow) && Boolean(this.textFlow.flowComposer))
      ...
      public function set inlineInfo(param1:*) : void
      {
         this._inlineInfo = param1;
      }
      
      public function set paddingLock(param1:Boolean) : void
      {
      ...
      public function getCharIndexAtPoint(param1:Number, param2:Number) : int
      {
         ...
         if(_loc3_)
         {
            ...
            return _loc6_.containsPoint(_loc4_) ? _loc5_ : (_loc5_ > 0 ? _loc5_ - 1 : _loc5_);
         }
         return -1;
      }
      ...
      public function linkClick(param1:FlowElementMouseEvent) : void
      {
