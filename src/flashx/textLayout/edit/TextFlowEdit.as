...
package flashx.textLayout.edit
{
     ...
     * @private - because we can't make it public. Used by the operations package 
	 */	
	public class TextFlowEdit
	{
		public static function deleteRange(textFlow:TextFlow, startPos:int, endPos:int):ParagraphElement
		{
		 ...
		 * 
		 */
		public static function insertNewSPBlock(theFlow:TextFlow, startPos:int, endPos:int, newSPB:SubParagraphGroupElementBase, spgClass:Class):Boolean
		{
		 ...
		 */
		public static function splitElement(elem:FlowElement, splitPos:int, splitSubBlockContents:Boolean):void
		{
		 ...
		 */
		public static function findAndSplitElement(fbe:FlowGroupElement, elementIdx:int, startIdx:int, splitSubBlockContents:Boolean):int
		{
		 ...
		 *  newSPB is of type <b>
		 */
		public static function subsumeElementsToSPBlock(parentFBE:FlowGroupElement, elementIdx:int, curPos:int, endPos:int, newSPB:SubParagraphGroupElementBase, spgClass:Class):int
		{
			var curFlowEl:FlowElement = null;
		 ...
		 */ 
		public static function findAndRemoveFlowGroupElement(theFlow:TextFlow, startPos:int, endPos:int, fbeClass:Class):Boolean
		{
			var curPos:int = startPos;
		 ...
		 */
		public static function canInsertSPBlock(theFlow:TextFlow, startPos:int, endPos:int, blockClass:Class):Boolean
		{
			if(endPos <= startPos)
				return false;
		 ...
		 */ 
		public static function flushSPBlock(subPB:SubParagraphGroupElementBase, spgClass:Class):void
		{
		...
		public static function findNextParagraph(para:ParagraphElement):ParagraphElement
		{
			if (para)
			{
		...
		public static function removeEmptyParentChain(parent:FlowGroupElement):IMemento
		{
