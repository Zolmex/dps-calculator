...
package flashx.textLayout.compose
{
	...
	public class ComposeState extends BaseCompose 
	{
		...
		/** @private */
		static public function getComposeState():ComposeState
		{
		...
		/** @private */
		static public function releaseComposeState(state:ComposeState):void
		{
		...
		{			
			...
			if (ContainerController.public::usesDiscretionaryHyphens)
			{
