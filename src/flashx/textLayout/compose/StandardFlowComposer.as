	...
	*/
	...
	public class StandardFlowComposer extends FlowComposerBase implements IFlowComposer
	{
		...
		*/
		...
		/** @private */
		public function getComposeState():ComposeState
		{ return ComposeState.getComposeState(); }
		
		/** @private */
		public function releaseComposeState(state:ComposeState):void
		{ ComposeState.releaseComposeState(state); }
		
		/** @private Return the first damaged controller */
		public function callTheComposer(composeToPosition:int, controllerEndIndex:int):ContainerController
		{
