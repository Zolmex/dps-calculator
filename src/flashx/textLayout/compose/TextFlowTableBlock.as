...
package flashx.textLayout.compose
{
	...
	public class TextFlowTableBlock extends TextFlowLine
	{
		 ...
		 * @inheritDoc
		 **/
		override public function initialize(paragraph:ParagraphElement, outerTargetWidth:Number = 0, lineOffset:Number = 0, absoluteStart:int = 0, numChars:int = 0, textLine:TextLine = null):void
		{
		...
		override public function setController(cont:ContainerController,colNumber:int):void
		{
		...
		public override function hiliteBlockSelection(selObj:Shape, selFormat:SelectionFormat, container:DisplayObject, begIdx:int, endIdx:int, prevLine:TextFlowLine, nextLine:TextFlowLine):void
		{
			// do nothing for now...
		}
