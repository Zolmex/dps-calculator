...
package flashx.textLayout.container
{
	...
	*/
	...
	{		
		...
		static public const editingModePropertyDefinition:Property = Property.NewEnumStringProperty("editingMode", EditingMode.READ_WRITE, false, null, 
		...
		* @playerversion AIR 1.5
 		* @langversion 3.0
		*/
		public final function requiredFocusInHandler(event:FocusEvent):void
		{			
		 ...
		 * 
		 */	
		public function addTextLine(textLine:TextLine, index:int):void
		{ 
		 ...
		 * 
		 */	
		public function removeTextLine(textLine:TextLine):void
		{
		 ...
		 * 
		 */
		public function addBackgroundShape(shape:Shape):void	// No PMD
		{
		 ...
		 * 
		 */
		public function removeBackgroundShape(shape:Shape):void	
		{
			if (shape.parent)
		 ...
		 * @see #container
		 */
		public function addSelectionContainer(selectionContainer:DisplayObjectContainer):void
		{
		 ...
		 * 
		 */
		public function removeSelectionContainer(selectionContainer:DisplayObjectContainer):void
		{	
		 ...
		 * 
		 */	
		public function addInlineGraphicElement(parent:DisplayObjectContainer, inlineGraphicElement:DisplayObject, index:int):void
		{
			if (parent)
		 ...
		 * 
		 */	
		public function removeInlineGraphicElement(parent:DisplayObjectContainer, inlineGraphicElement:DisplayObject):void
		{
...
class TCMFactoryDisplayComposer extends FactoryDisplayComposer
{
	...
	public override function callTheComposer(absoluteEndPosition:int, controllerEndIndex:int):ContainerController
	{
