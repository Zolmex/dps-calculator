...
package flashx.textLayout.container 
{
	...
	{		
		...
		public function get interactiveObjects():Dictionary
		{
		...
		*/
		 ...
		 * @private
		 */
		public function setRootElement(value:ContainerFormattedElement):void
		{
		 ...
		 * @private
		 */
		public function formatChanged():void
		{
		...
		/** @private */ 
		public function getFirstVisibleLine():TextFlowLine
		{ return _shapeChildren.length ? _shapeChildren[0].userData : null; }
		/** @private */
		public function getLastVisibleLine():TextFlowLine
		...
		/** @private */
		public function getContainerController(container:DisplayObject):ContainerController
		{
			try
			{
				while (container)
		...
		public function requiredFocusInHandler(event:FocusEvent):void
		{
			attachAllListeners();
		...
		public function requiredFocusOutHandler(event:FocusEvent):void
		{
		...
		{			
			...
			{
				var contextMenu:ContextMenu = ContextMenu(_container.contextMenu);
				if (contextMenu)
				{
		...
		public function addCellSelectionShapes(color:uint, tableBlock:TextFlowTableBlock, startCoords:CellCoordinates, endCoords:CellCoordinates): void
		{
			if(!tableBlock)
				return;
		 ...
		 * */
		public function addCellSelections(cells:Array, color:uint, tableBlock:TextFlowTableBlock): void
		{
		...
		public function addSelectionChild(child:DisplayObject):void
		{
		...
		public function containsSelectionChild(child:DisplayObject):Boolean
		{ 
			var selectionSprite:DisplayObjectContainer = getSelectionSprite(false);
			if (selectionSprite == null)
			{
	...
	/*	CONFIG::debug private function containsFloats(textFlow:TextFlow):Boolean
		...
		/** @private */
		public function getSelectionSprite(createForDrawing:Boolean):DisplayObjectContainer
		{
			if (createForDrawing)
			{
...
*/
		 ...
		 * */
		public function testLineVisible(wmode:String, scrollXTW:int, scrollYTW:int, scrollWidthTW:int, scrollHeightTW:int, textFlowLine:TextFlowLine, textLine:TextLine):*
		{
		 ...
		 * */
		public function oldTestLineVisible(wmode:String, scrollXTW:int, scrollYTW:int, scrollWidthTW:int, scrollHeightTW:int, textFlowLine:TextFlowLine, textLine:TextLine):TextLine
		{
			// So this is another take on figuring out whether the line bounds intersects the visible area of the container. 
			// This code figures out the logical bounds of the line, and uses that for the intersection. There was a 
			// previous version of this code that uses the DisplayObject's getBounds function, which will include information
	...
	/*	This code may turn out to be useful for iterating through the floats and doing some function,
		...
		/** @private */
		public function getPlacedTextLineBounds(textLine:TextLine):Rectangle
		{
		...
		CONFIG::debug
		{
			...
			/** @private */
			public function verifyPlacedTextLineBounds(textLine:TextLine,newBounds:Rectangle):void
			{
		...
		/** @private */
		public function addComposedLine(textLine:TextLine):void
		{
			_linesInView.push(textLine);			
		}
		 ...
		 * @private
		 */
		public function addFloatAt(absolutePosition:int, float:DisplayObject, floatType:String, x:Number, y:Number, alpha:Number, matrix:Matrix, depth:Number, knockOutWidth:Number, columnIndex:int, parent:DisplayObjectContainer):void
		{
