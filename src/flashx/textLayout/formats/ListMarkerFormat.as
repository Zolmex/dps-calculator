...
package flashx.textLayout.formats
{
	...
	public class ListMarkerFormat extends TextLayoutFormat implements IListMarkerFormat
	{
		...
		/** @private */
		static public const beforeContentProperty:Property = Property.NewStringProperty("beforeContent", null, false, Vector.<String>([Category.LIST]));
		/** @private */
		...
		/** @private */
		static public const afterContentProperty:Property  = Property.NewStringProperty("afterContent", null, false, Vector.<String>([Category.LIST]));
		/** @private */
		static public const suffixProperty:Property = Property.NewEnumStringProperty("suffix", Suffix.AUTO, false, Vector.<String>([Category.LIST]), Suffix.AUTO, Suffix.NONE);
