	...
	*/
	...
	{		
		...
		* @playerversion AIR 1.5
		 ...
		 * @private
		 */
		public function findAbsoluteParagraph(pos:int):ParagraphElement
		{
		 ...
		 * @private
		 */
		 public function findAbsoluteFlowGroupElement(pos:int):FlowGroupElement
		 {
		 	var elem:FlowElement = findLeaf(pos);
		 	return elem.parent;
		 }
		...
		/** @private */
		public function appendOneElementForUpdate(elem:FlowElement):void
		{
