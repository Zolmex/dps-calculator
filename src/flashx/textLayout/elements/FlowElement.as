 ...
 */
	public class FlowElement implements ITextLayoutFormat
	{
		...
		/** start, _start of element, relative to parent; public to eliminate getter calls  */
		private var _parentRelativeStart:int = 0;		
		
		/** _textLength (number of chars) in the element, including child content; public to eliminate getter calls */
		...
		* @playerversion AIR 1.5
		...
		public function setParentAndRelativeStart(newParent:FlowGroupElement,newStart:int):void
		...
		public function setParentAndRelativeStartOnly(newParent:FlowGroupElement,newStart:int):void
		...
		public function getAncestorWithContainer():ContainerFormattedElement
		{
		...
		/** @private */		
		public function set impliedElement(value:*):void
		{
		...
		*/
		 ...
		 * @private
		 */
		public function modelChanged(changeType:String, element:FlowElement, changeStart:int, changeLen:int, needNormalize:Boolean = true, bumpGeneration:Boolean = true):void
		{
		...
		/** @private */
		public function appendElementsForDelayedUpdate(tf:TextFlow,changeType:String):void
		{ }
		
		/** @private */
		public function applyDelayedElementUpdate(textFlow:TextFlow,okToUnloadGraphics:Boolean,hasController:Boolean):void
		{ }
		...
		* @playerversion AIR 1.5
		...
		/** @private */
		public function getEnclosingController(relativePos:int) : ContainerController
		{
		...
		public function quickCloneTextLayoutFormat(sibling:FlowElement):void
		{
		...
		public function updateForMustUseComposer(textFlow:TextFlow):Boolean
		{ return false; }
		...
		/** @private */
		public static function createTextLayoutFormatPrototype(localStyles:ITextLayoutFormat,parentPrototype:TextLayoutFormat):TextLayoutFormat
		{			
