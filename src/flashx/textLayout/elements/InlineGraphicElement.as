...
package flashx.textLayout.elements 
{
    ...
    {   
        ...
        */
        ...
        /** @private */
        public function get placeholderGraphic():Sprite
        {
        ...
        static public const heightPropertyDefinition:Property = Property.NewNumberOrPercentOrEnumProperty("height", FormatValue.AUTO, false, null, 0, 32000, "0%", "1000000%", FormatValue.AUTO );
        
        /** Definition of the width property @private */
        static public const widthPropertyDefinition:Property = Property.NewNumberOrPercentOrEnumProperty("width", FormatValue.AUTO, false, null, 0, 32000, "0%", "1000000%", FormatValue.AUTO );
        
        /** Disabled due to player bug.  @private */
        static public const rotationPropertyDefinition:Property = Property.NewEnumStringProperty("rotation", TextRotation.ROTATE_0, false, null, 
        ...
        static public const floatPropertyDefinition:Property = Property.NewEnumStringProperty("float", Float.NONE, false, null, 
        ...
        */
         ...
         * */
        public override function applyDelayedElementUpdate(textFlow:TextFlow,okToUnloadGraphics:Boolean,hasController:Boolean):void
        {
        ...
        public override function updateForMustUseComposer(textFlow:TextFlow):Boolean
        { 
        ...
        public function getTypographicAscent(textLine:TextLine):Number
        {
            if (effectiveFloat != Float.NONE)
                return 0;
         ...
         */
        override public function getCSSInlineBox(blockProgression:String, textLine:TextLine, para:ParagraphElement=null, swfContext:ISWFContext=null):Rectangle
        {
            if (effectiveFloat != Float.NONE)
                return null;
        ...
        /** @private */
        override public function updateIMEAdornments(tLine:TextLine, blockProgression:String, imeStatus:String):void
        {
        ...
        /** @private */
        override public function updateAdornments(tLine:TextLine, blockProgression:String):int
        {
            // Don't underline for floats
            if (effectiveFloat == Float.NONE)
        ...
        /** @private */
        public override function appendElementsForDelayedUpdate(tf:TextFlow,changeType:String):void
        { 
        ...
        /** @private */
        public override function calculateStrikeThrough(tLine:TextLine, blockProgression:String, metrics:FontMetrics):Number
        {
        ...
        /** @private */
        public override function calculateUnderlineOffset(stOffset:Number, blockProgression:String, metrics:FontMetrics, tLine:TextLine):Number
        {
            if (!this.graphic || status != InlineGraphicElementStatus.READY)
