...
package flashx.textLayout.elements
{
	...
	*/
	...
	{				
		...
		/** @private */
		public override function setParentAndRelativeStart(newParent:FlowGroupElement,newStart:int):void
		{
			if (newParent == parent)
				return;
		...
		/** @private */
		public static function resolveDomBaseline(computedFormat:ITextLayoutFormat, para:ParagraphElement):String
		{
		...
		/** @private */
		static public function computeElementFormatHelper(computedFormat:ITextLayoutFormat, para:ParagraphElement, swfContext:ISWFContext):ElementFormat
		{
		 ...
		 */
		public function getCSSInlineBox(blockProgression:String, textLine:TextLine, para:ParagraphElement=null, swfContext:ISWFContext=null):Rectangle
		{
		 ...
		 */
		static public function getCSSInlineBoxHelper(computedFormat:ITextLayoutFormat, metrics:FontMetrics, textLine:TextLine, para:ParagraphElement=null):Rectangle
		{
		...
		/** @private */
		public function getSpanBoundsOnLine(textLine:TextLine, blockProgression:String):Array
		{
		...
		/** @private */
		public function updateIMEAdornments(tLine:TextLine, blockProgression:String, imeStatus:String):void
		{
		...
		public function updateAdornments(tLine:TextLine, blockProgression:String):int
		{
		...
		/** @private */
		public function calculateStrikeThrough(textLine:TextLine, blockProgression:String, metrics:FontMetrics):Number
		{
		...
		/** @private */
		public function calculateUnderlineOffset(stOffset:Number, blockProgression:String, metrics:FontMetrics, textLine:TextLine):Number
		{
