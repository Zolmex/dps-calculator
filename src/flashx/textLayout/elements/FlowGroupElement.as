...
package flashx.textLayout.elements 
{
	...
	public class FlowGroupElement extends FlowElement
	{
		...
		* @playerversion AIR 1.5
		...
		/** @private */
		public function getNextLeafHelper(limitElement:FlowGroupElement,child:FlowElement):FlowLeafElement
		{
		...
		/** @private */
		public function getPreviousLeafHelper(limitElement:FlowGroupElement,child:FlowElement):FlowLeafElement
		{
			var idx:int = getChildIndex(child);
			if (idx == -1)
				return null;	// bug?
		...
		/** @private */
		public function removeBlockElement(child:FlowElement, block:ContentElement):void
		{
		...
		/** @private */
		public function insertBlockElement(child:FlowElement, block:ContentElement):void
		{
			// when Image's are moved into ParagraphElement's this assertion should always fire
		...
		public function addChildAfterInternal(child:FlowElement, newChild:FlowElement):void
		{
		 ...
		 * @private 
		 */
		public function canOwnFlowElement(elem:FlowElement):Boolean
		{
