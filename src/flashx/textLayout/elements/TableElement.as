...
package flashx.textLayout.elements
{
	...
	public class TableElement extends TableFormattedElement 
	{
		...
		/** @private */
		public override function getNextLeafHelper(limitElement:FlowGroupElement,child:FlowElement):FlowLeafElement
		{
			return parent.getNextLeafHelper(limitElement,this);
		}
		
		/** @private */
		public override function getPreviousLeafHelper(limitElement:FlowGroupElement,child:FlowElement):FlowLeafElement
		{
		 ...
		 **/
		public function createRowElement(index:int, defaultRowFormat:ITextLayoutFormat):TableRowElement {
