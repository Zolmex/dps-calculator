...
//					tbs.push(new TextBlock());
		...
		/** @private */
		public function releaseTextBlock(tb:TextBlock=null):void
		{
			updateTextBlockRefs();
			if(tb)
			{
		...
		public function getTextBlocks():Vector.<TextBlock>
		{
			if(_textBlocks == null)
		...
		public function getLastTextBlock():TextBlock
		{
			var tbs:Vector.<TextBlock> = getTextBlocks();
			if(!tbs.length)
				createTextBlock();
		...
		public function getTextBlockAtPosition(pos:int):TextBlock
		{
			var curPos:int = 0;
			var posShift:int = 0;
		...
		public function getTextBlockAbsoluteStart(tb:TextBlock):int
		{
		...
		public function getTextBlockStart(tb:TextBlock):int
		{
			var i:int;
			var curPos:int = 0;
			var tbs:Vector.<TextBlock> = getTextBlocks();
		...
		public function peekTextBlock():TextBlock
		{ 
		...
		public override function createContentAsGroup(pos:int=0):GroupElement
		{
 		...
 		/** @private */
		public override function removeBlockElement(child:FlowElement, block:ContentElement):void
		{
		...
		/** @private */
		public override function insertBlockElement(child:FlowElement, block:ContentElement):void
		{
			var relativeStart:int = child.getElementRelativeStart(this);
		...
		/** @private */
		public function updateTerminatorSpan(splitSpan:SpanElement,followingSpan:SpanElement):void
		{
		...
		public function findPreviousAtomBoundary(relativePosition:int):int
		{
			...
			if (ContainerController.public::usesDiscretionaryHyphens && tl != null)
			{
		...
		public function get terminatorSpan():SpanElement
		{
