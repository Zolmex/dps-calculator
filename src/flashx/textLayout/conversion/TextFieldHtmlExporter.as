...
package flashx.textLayout.conversion
{
	...
	*/
	public class TextFieldHtmlExporter extends ConverterBase implements ITextExporter	
	{
		 ...
		 * @private
		 */
		public function exportToXML(textFlow:TextFlow) : XML
		{
			var html:XML = <HTML/>;
		...
		static public function makeTaggedTypeName(elem:FlowElement,defaultTag:String):XML
		{
		...
		public static function exportStyling(elem:FlowElement, xml:XML):void
		{
			if (elem.id != null)
				xml.@["id"] = elem.id;
		...
		public function exportChildren(elem:FlowGroupElement,parentXML:XML):void
		{
		...
		public function exportList(list:ListElement, parentXML:XML):void
		{
			var xml:XML;
		 ...
		 * @private
		 */
		public function exportParagraph(para:ParagraphElement, parentXML:XML):void
		{
			// Exported as a <P/>
		 ...
		 * @private
		 */	
		public function exportParagraphFormat(xml:XML, para:ParagraphElement):XML
		{	
		 ...
		 * @private
		 */
		public function exportElement(flowElement:FlowElement, parentXML:XML):void
		{
		 ...
		 * @private
		 */
		public function exportSubParagraphChildren(flowGroupElement:FlowGroupElement, parentXML:XML):void
		{
